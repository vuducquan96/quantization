...
from core.core import preprocess as prep
from core.core.geometry import points_in_convex_polygon_3d_jit
from core.datalibs.datasets import kitti
import itertools
...
def prep_sequence_pointcloud(
    ...
    max_num_voxels = prep_cfg.max_num_voxels_NUM
    ...
    # key frame voxel
    keyframe_info = voxel_generator.generate(keyframe_points, max_num_voxels)
