...
from core.datalibs.processor.data_processor import DataProcessor
    ...
    def prepare_data(self, data_dict):
        ...
        Returns:
            data_dict:
                ...
                coordinates: optional (num_voxels, 3)
                num_points: optional (num_voxels)
                ...
        """
        if self.training:
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        for key, val in data_dict.items():
            try:
                ...
                elif key in ['points', 'coordinates']:
                    coors = []
